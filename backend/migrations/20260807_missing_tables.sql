...
-- datapivot_core_data 表原本只在 docker/postgres/init/002_datapivot_core_data.sql 中定义，
...
-- datapivot_core_data（从 docker/postgres/init/002_datapivot_core_data.sql 迁入）
