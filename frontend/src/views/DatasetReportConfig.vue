              ...
              <div class="rc-card">
                ...
                <div class="rc-card-body">
                  ...
                  <div class="rc-field-grid">
                    ...
                    <div class="rc-field">
                      <label>线列</label>
                      <el-input v-model="configForm.trackColumn" size="small" placeholder="线" />
                    </div>
                    <div class="rc-field">
                      <label>层级列</label>
              ...
              <div class="rc-card rc-card-wide">
                ...
                <div class="rc-card-body">
                  <div class="rc-field">
                    ...
                    <el-input v-model="configForm.businessContext" type="textarea" :rows="3" size="small" placeholder="例如：源数据没有父子字段，组织链路由 SQL 从战区/片区/客户经理字段生成。" />
                  </div>
              ...
              <div class="rc-card rc-card-wide">
                ...
                <div class="rc-card-body">
                  ...
                  <div class="rc-field-grid">
                    <div class="rc-field">
                      <label>必需结构列</label>
                      <el-input v-model="requiredColumnsText" size="small" placeholder="线, 层级, 节点名称, 上级名称" />
                    </div>
                    <div class="rc-field">
                      <label>指标输出列</label>
                ...
                <div class="rc-card-body">
                  ...
                  <div class="rc-field" style="margin-top:12px">
                    ...
                    <el-input
                      ...
                      :rows="4"
                      size="small"
                      placeholder="每行一个层级，例如：战区=战区,区域公司&#10;城市站=城市站,城市战区"
                    />
                  </div>
                  ...
                  <div class="rc-help-text rc-help-text-bottom">
                    例如“消费者前三的战区”会命中排名意图，目标层级取“战区”，TopN 取 3，排序指标默认取上方选择的指标。
                  </div>
                </div>
              </div>
...
.rc-card-title {
  ...
  background: var(--gray-50, #F4F7FA); border-bottom: 1px solid var(--border-light, #F3F4F6);
  display: flex; align-items: center; justify-content: space-between;
}
