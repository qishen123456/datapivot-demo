"""
Export datapivot_core_data rows into a portable JSON bundle.

Usage:
  python backend/export_datapivot_core_data.py
  python backend/export_datapivot_core_data.py backend/imports/datapivot_core_data_bundle.json
"""
...
DEFAULT_OUTPUT = os.path.join(
    ...
    "imports",
    "datapivot_core_data_bundle.json",
)
