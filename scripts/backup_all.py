...
Output:
    ...
    backups/<timestamp>/datapivot_core_data_bundle.json
...
def main() -> int:
    ...
    # 3. Business data
    def _export_datapivot():
        from export_datapivot_core_data import export_bundle as _exp

        return _exp(os.path.join(out_dir, "datapivot_core_data_bundle.json"))

    results["datapivot_core_data"] = _run("export_datapivot_core_data", _export_datapivot)
